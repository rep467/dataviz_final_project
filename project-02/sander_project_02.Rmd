...
### bad example
```{r, fig.alt="A bar graph showing the top ten countries by participation in the Boston Marathon 2017"}
...
```{r, echo=FALSE, fig.alt="World map showing from which countries the Boston marathon 2017 participants were."}
browsable(
  tags$div(
...
### Average Time
```{r, echo=FALSE, fig.alt="World map showing average finish times of each countries participants."}
browsable(
  tags$div(
...
```{r, fig.alt="Scatterplot showing the average finish time vs numbers of participants. A linear trend line shows a weak trend that countries with low participation seem to have better finish times."}
graph3
```

```{r, fig.alt="Coefficient Plot for the prvious scatterplot:'Scatterplot showing the average finish time vs numbers of participants'."}
graph3a
