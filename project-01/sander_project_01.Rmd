...
```{r, fig.alt="This graph is scatterplot graph with each point being a car for the year x and the mpg y. Most data points seem to be below 25mpg with a small cluster after 2010 being at arround 100mpg"}
...
## Graph 2
```{r, fig.alt="This graph is scatterplot graph with each point being a car for the year x and the mpg y. This scatterplot shows that the average remained around 19 mpg until 2008. From 2009 it started to increase reaching 23.7 in 2017."}
...
```{r, fig.alt="This graph is an interactive Boxplot graph with one boxplot for each year showing the mpg of all cars. This Boxplot shows that the average remained around 19 mpg until 2008. From 2009 it started to increase reaching 23.7 in 2017. Even in 1984 outliers with mpg above 30 existed."}
...
```{r, fig.alt="This graph consists of a scatterplot of the top 10% of cars by MPG. The trend  line starts at 30mpg in 1984 decreases a little bit until 2006 to then increase to about 35mpg by 2017."}
...
```{r, fig.alt="A line chart displaying the amount of cars by each fuel type for each year. Most cars are Regular starting at 1702 in 1984 but decreased to 559 by 2017. Premium cars started at 101 in 1985 and increased to 541 by 2017. Diesel starts at 262 in 1984 decreses sharply ending at 15 in 2017"}
