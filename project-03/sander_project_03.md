...
## 3  2022     5    30          1.65       96       73     84.5
## 4  2022    10    26          0          83       69     76
```
...
## saving Frequency graphs of part2
...
saveWidget(widget=girafe(ggobj=graph2A1), file = "../figures/project-3-part-2-interactive-graph-tab-1.html", selfcontained = TRUE)
saveWidget(widget=girafe(ggobj=graph2A2), file = "../figures/project-3-part-2-interactive-graph-tab-2.html", selfcontained = TRUE)
saveWidget(widget=girafe(ggobj=graph2A3), file = "../figures/project-3-part-2-interactive-graph-tab-3.html", selfcontained = TRUE)
```
