...
When hovering over the bars total occurrences and unique occurrences in songs are shown. 
Furthermore, the graph can be switched between showing the most common word, bigrams of length 2, or bigrams of length 3.
Through these interactive graph, I noticed that the dataset is missing spaces in the song lyrics. (check out report for more info)
