...
### words
```{r, fig.alt ="Bar chart of the top 10 most frequent words from the top 100 Lyrics of 2015",  echo=FALSE}
browsable(
  tags$div(
...
### bigrams length 2
```{r, fig.alt ="Bar chart of the top 10 most frequent bigrams length 2 from the top 100 Lyrics of 2015",  echo=FALSE}
browsable(
  tags$div(
...
### bigrams length 3
```{r, fig.alt ="Bar chart of the top 10 most frequent bigrams length 3 from the top 100 Lyrics of 2015",  echo=FALSE}
browsable(
  tags$div(
