...
```{r, fig.alt="A histogram showing the maximum temperatures in each month and there frequency by nr of days.", warning=FALSE, message=FALSE}
...
```{r, fig.alt="A graph showing the probability density for maximum temperature for the entire year.", warning=FALSE, message=FALSE}
...
```{r fig.alt="Graphs showing the probability density for maximum temperature for each month.", warning=FALSE, message=FALSE}
months <- c("1"="January", "2"="February", "3"="March", "4"="April", "5"="May", "6"="June", 
            "7"="July", "8"="August", "9"="September", "10"="October", "11"="November", "12"="December")
...
```{r, fig.alt="A graph showing the probability density for maximum temperature for each month with a marked median.", warning=FALSE, message=FALSE}
library(ggridges)
...
```{r, fig.alt="A bar graph showing precipitaition per month.", warning=FALSE, message=FALSE}
...
### words
```{r, fig.alt ="Bar chart of the top 10 most frequent words from the top 100 Lyrics of 2015",  echo=FALSE, warning=FALSE, message=FALSE}
browsable(
  tags$div(
    `aria-label` = "Bar chart of the top 10 most frequent words from the top 100 Lyrics of 2015",
    role = "img",
...
### bigrams length 2
```{r, fig.alt ="Bar chart of the top 10 most frequent bigrams length 2 from the top 100 Lyrics of 2015",  echo=FALSE, warning=FALSE, message=FALSE}
browsable(
  tags$div(
    `aria-label` = "Bar chart of the top 10 most frequent bigrams length 2 from the top 100 Lyrics of 2015",
    role = "img",
...
### bigrams length 3
```{r, fig.alt ="Bar chart of the top 10 most frequent bigrams length 3 from the top 100 Lyrics of 2015",  echo=FALSE, warning=FALSE, message=FALSE}
browsable(
  tags$div(
    `aria-label` = "Bar chart of the top 10 most frequent bigrams length 3 from the top 100 Lyrics of 2015",
    role = "img",
